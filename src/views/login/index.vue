    ...
    <div class="login-container">
      <el-form class="login-form" autocomplete="on" label-position="left">
        ...
        <el-form-item prop="username">
          ...
          <el-input placeholder="Username"  name="username" type="text" autocomplete="on"/>
        </el-form-item>

        <el-tooltip >
          <el-form-ietm prop="password">
            <span class="svg-container">
              <svg-icon icon-class="password" />
            </span>
            <el-input  placeholder="Password" name="password"  autocomplete="on"/>
            <span class="show-pwd" >
            <svg-icon />
            </span>
          </el-form-ietm>
